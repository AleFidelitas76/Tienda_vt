...
public interface ProductoRepository extends JpaRepository<Producto, Long>{
    ...
    //Consulta ampliada para recuperar  los productos que tienen un rango de precios, ordenados por precio 
    public List<Producto> findByPrecioBetweenOrderByPrecio(double precioInf, double precioSup);
    
    //Consulta JPQL  para recuperar  los productos que tienen un rango de precios, ordenados por precio 
    @Query(value = "SELECT a FROM Producto a WHERE a.precio BETWEEN :precioInf AND :precioSup ORDER BY a.precio")
    public List<Producto> consultaJPQL(double precioInf, double precioSup);

    //Consulta SQL para recuperar  los productos que tienen un rango de precios, ordenados por precio 
